...
<section id="about" data-aos="fade-down" data-aos-duration="1500">
...
<section id="schedule">
    <div class="schedule-wrapper" data-aos="zoom-in" data-aos-duration="1000">
...
<section id="gallery">
    <h1 class="gallery-title my-3" data-aos="zoom-in" data-aos-duration="1000">•<span>Gallery</span>•</h1>
...
<section id="information">
    <div class="information-wrapper container text-center px-5" data-aos="fade" data-aos-duration="1000">
    ...
    <div class="stream-wrapper container text-center mt-4 mb-5 py-5" data-aos="fade" data-aos-duration="1000">
        <h3>Live Stream</h3>
        <div class="d-flex justify-content-center mt-4">
            <iframe width="100%" height="100%" src="https://www.youtube.com/embed/SYQ4efaVN4A" allowfullscreen></iframe>
        </div>
    </div>
    <x-display.running-text />
